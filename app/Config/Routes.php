...
$routes->get('nota/setup', 'Nota::setup');
$routes->post('nota', 'Nota::store');
$routes->get('nota/(:num)', 'Nota::show/$1');
$routes->delete('nota/(:num)', 'Nota::destroy/$1');
$routes->post('nota/setup', 'Nota::storesetup');
